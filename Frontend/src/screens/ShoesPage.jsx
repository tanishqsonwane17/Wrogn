...
import { shoesAssets } from '../data/ShoesData';
...
const ShoesPage = ({ cartCount, setCartCount, setCartItems }) => {
  ...
  let filteredProducts = shoesAssets.slice();
